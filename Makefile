...
TODO_CODECS_TABLE+=from/ANSI-CONTROL
...
TODO_CODECS_TABLE+=from/BSDCONV_LOG
...
TODO_CODECS_TABLE+=inter/AMBIGUOUS-PAD
TODO_CODECS_TABLE+=inter/BIG5-DEFRAG
...
TODO_CODECS_TABLE+=to/ANSI-CONTROL
...
TODO_CODECS_TABLE+=to/ASCII-HTML-INFO
...
TODO_CODECS_TABLE+=to/BSDCONV_LOG
TODO_CODECS_TABLE+=to/BSDCONV_RAW
...
TODO_CODECS_CALLBACK+=inter/AMBIGUOUS-PAD
TODO_CODECS_CALLBACK+=inter/BIG5-DEFRAG
TODO_CODECS_CALLBACK+=to/3F
TODO_CODECS_CALLBACK+=to/ANSI-CONTROL
...
TODO_CODECS_CALLBACK+=to/ASCII-HTML-INFO
TODO_CODECS_CALLBACK+=to/ASCII-HTML-UNICODE-IMG
TODO_CODECS_CALLBACK+=to/BSDCONV
TODO_CODECS_CALLBACK+=to/BSDCONV_LOG
TODO_CODECS_CALLBACK+=to/BSDCONV_RAW
